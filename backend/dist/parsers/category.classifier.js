 ...
 */
function classifyCategory(params) {
    ...
    if (emailClass === 'bank_transfer' || emailClass === 'neft_credit' || emailClass === 'neft_debit' ||
        emailClass === 'rtgs_credit' || emailClass === 'rtgs_debit')
        return 'bank_transfer';
    if (emailClass === 'imps_credit' || emailClass === 'imps_debit')
        return 'bank_transfer';
    ...
    // Type-based fallback
    if (emailClass === 'upi_credit' || emailClass === 'bank_credit')
        return 'other';
    if (emailClass === 'upi_debit' || emailClass === 'bank_debit' || emailClass === 'card_debit')
        return 'other';
