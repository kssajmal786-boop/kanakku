...
export type TransactionCategory = 'food' | 'transport' | 'shopping' | 'entertainment' | 'health' | 'education' | 'utilities' | 'rent' | 'salary' | 'investment' | 'atm_withdrawal' | 'bank_transfer' | 'upi_transfer' | 'refund' | 'subscription' | 'insurance' | 'tax' | 'other' | 'uncategorized';
