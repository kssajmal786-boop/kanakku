 ...
 */
export function extractUpiVpa(text: string): string | null {
 ...
 */
export function extractAccountSuffix(text: string): string | null {
  const patterns = [
 ...
 */
export function extractAvailableBalance(text: string): number | null {
  const patterns = [
